  ...
  return (
    <div className="burnmap">
      ...
      <main>
        <section className="hero" id="solution">
          <div className="hero-copy">
            <p className="eyebrow">
              Proactive burnout forecasting + peer mentorship
            </p>
            ...
            <p className="lead">
              ...
              early, and connects students and early-career professionals to
        ...
        <section className="story">
          <div className="story-panel">
            ...
            <p>
              It grows slowly: pressure piles up, career clarity fades, and
              financial anxiety amplifies every decision. BurnMap watches the
              build-up so intervention feels calm, not clinical.
            </p>
          ...
          <div className="story-panel highlight">
            ...
            <p>
              Anchors are trained peers 2-3 years ahead. They have walked the
              same path and can talk about uncertainty without the stigma of
              "therapy."
            </p>
        ...
        <section className="passport" id="passport">
          <div className="passport-card">
            <div>
              ...
              <p>
                Export a private log of stress signals, coping tools, and
                milestones survived. Share it only when you choose - or keep it
                fully local.
              </p>
        ...
        <section className="cta">
          <div className="cta-card">
            ...
            <p>
              Join the waitlist for early access and help shape a platform that
              respects privacy and delivers real human support.
            </p>
            <div className="cta-row">
      ...
      <footer className="footer">
        ...
        <p>
          All behavioral data stays local first and syncs only with explicit
          consent.
        </p>
      </footer>
    </div>
